...
class IngresoProductosForm(forms.ModelForm):
    estado = forms.ModelChoiceField(queryset=EstadoProducto.objects.all())
    class Meta:
...
class SacarDelInventarioForm(forms.Form):
    ingreso_id = forms.IntegerField(widget=forms.HiddenInput())
